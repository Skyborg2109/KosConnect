        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            if ($emailSent) {
                ...
                if (getenv('MYSQLHOST')) {
                    ...
                    $_SESSION['registration_success'] = "Registrasi berhasil! (Email gagal dikirim, tetapi akun Anda telah diaktifkan otomatis oleh sistem).";
                } else {
...
<head>
    ...
    <title>Register Penyewa - KosConnect</title>
...
<body>
    ...
    <div class="wrapper">
        <div>
            <form class="register-form" method="POST" action="RegisterForm.php">
            <div class="header">
                <h1 class="title">Kos<span class="highlight">Connect</span></h1>
                <h2 class="subtitle">Register Penyewa</h2>
                <p class="welcome">Daftar sebagai penyewa</p>
            </div>
