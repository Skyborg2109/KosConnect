...
// Jika metode GET, ambil notifikasi
// Note: Removed 'WHERE is_read = 0' logic from owner's version if present implicitly here?
// Actually owner version was "SELECT ... WHERE id_user = ? ORDER BY ...". It didn't filter by is_read=0 for the LIST. 
// It listed everything but only cleared them on POST. This is correct behavior.
